...
export const Route = createFileRoute("/auth")({
  head: () => ({ meta: [{ title: "Entrar — Fintra" }, { name: "description", content: "Entre na Fintra para salvar e acompanhar sua vida financeira." }, { property: "og:title", content: "Entrar — Fintra" }, { property: "og:description", content: "Acesse seu controle financeiro pessoal." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }] }),
  component: AuthPage,
});
